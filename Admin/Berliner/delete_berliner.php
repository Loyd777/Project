...
<div class="row">
        ...
        <br>
        <form class="form" role="form" action="delete_berliner.php" method="post">
            ...
            <div class="form-action">
                <button type="submit" class="btn btn-warning"
                 data-bs-toggle="tooltip" data-bs-placement="top" title="Cette est irréverssible">Oui</button>
                <a class="btn btn-default" href="index_berliner.php"
