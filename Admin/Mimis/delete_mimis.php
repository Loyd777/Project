...
?>
    <div class="row">
        ...
        <br>
        <form class="form" role="form" action="delete_mimis.php" method="post">
            <input type="hidden" name="id" value="<?php echo $id;?>"/>
            <p class="alert-warning">Etes vous sûr de vouloir supprimer <span class="glyphicon glyphicon-ban-circle"> .</span></p>

            <div class="form-action">
                <button type="submit" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Cette action est irréversible">Oui</button>
                <a class="btn btn-default" href="index_mimis.php"
