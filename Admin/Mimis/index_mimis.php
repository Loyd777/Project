...
?>
    <div class="row">
       ...
       <h1><strong>Liste des items </strong><a href="insert_mimis.php" class="btn btn-success btn-lg"
                                               data-bs-toggle="tooltip" data-bs-placement="top" title="Ajouter un repas">
            <span class="glyphicon glyphicon-plus"></span> Ajouter</a>

           <a href="../log-out.php?logout=1" class="btn btn-danger btn-lg" style="transform: translate(500px)" id="logout"
              type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Se déconnecter du compte">Déconnexion
               <span class="glyphicon glyphicon-log-out"></span></a>

       </h1>
        <h4 ><a href="../../Mimis.php"
         data-bs-toggle="tooltip" data-bs-placement="top" title="Aller sur la page du restaurant Mimi's" style="color: #e7480f;;
text-shadow: 2px 2px black;font-family: 'Holtwood One SC';">Mimi's</a></h4>
        ...
        menu.nom AS category_id FROM repas LEFT JOIN menu ON repas.category_id = menu.id WHERE `restau_id`= 1 
        ...
        while($repas = $statement->fetch())
        {
           ...
           echo'<td>'.$repas['nom']. '</td>' ;
            ...
            echo'<td width="300"> '  ;
             echo'<a class="btn btn-default" href="view_mimis.php?id=' . $repas['id'] .'"
data-bs-toggle="tooltip" data-bs-placement="top" title="Voir le repas"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>' ;
             echo ' ';
              echo'<a class="btn btn-primary" href="update_mimis.php?id=' . $repas['id'] .'"
data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier le repas"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>'  ;
            echo ' ';
               echo'<a class="btn btn-danger" href="delete_mimis.php?id=' . $repas['id'] .'"
