...
//Vérification du remplissement des champs.
 if (!empty($_POST))
 {
     ...
     if ($isSucces && $isUploadSucces){
         $db = Database::connect();
         $statement = $db->prepare("INSERT INTO repas (nom,description,price,category_id,image,restau_id) value(?, ?, ?, ?, ?,5) ");
...
?>
        ...
        <br>
        <form class="form" role="form" action="insert_cornetto.php" method="post" enctype="multipart/form-data">
