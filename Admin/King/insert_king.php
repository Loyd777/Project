...
//Vérification du remplissement des champs.
 if (!empty($_POST))
 {
     ...
     if ($isSucces && $isUploadSucces){
         $db = Database::connect();
         $statement = $db->prepare("INSERT INTO repas (nom,description,price,category_id,image,restau_id) value(?, ?, ?, ?, ?,6) ");
...
?>
        ...
        <br>
        <form class="form" role="form" action="insert_king.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-action">
            <button type="submit" class="btn btn-success"
             data-bs-toggle="tooltip" data-bs-placement="top" title="Ajouter un repas"><span class="glyphicon glyphicon-plus"></span> Ajouter</button>
