...
?>
    <div class="row">
       <h1><strong>Liste des items </strong><a href="insert_cigusta.php" class="btn btn-success btn-lg"
        ...
        <h4><a href="../../cigusta.php" style="color: #e7480f;;
text-shadow: 2px 2px black;font-family: 'Holtwood One SC',sans serif;">Cigusta</a></h4>
        ...
        menu.nom AS category_id FROM repas LEFT JOIN menu ON repas.category_id = menu.id WHERE repas.restau_id = 3 
        ORDER BY repas.id DESC');                                                    /* repas.restau_id =  restaurant.id */
        while($repas = $statement->fetch())
        {
           ...
           echo'<td>'.$repas['nom']. '</td>' ;
            ...
            echo'<td width="300"> '  ;
             echo'<a class="btn btn-default" href="view_cigusta.php?id=' . $repas['id'] .'"
 data-bs-toggle="tooltip" data-bs-placement="top" title="Voir le repas"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>' ;
             echo ' ';
              echo'<a class="btn btn-primary" href="update_cigusta.php?id=' . $repas['id'] .'"
 data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier le repas"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>'  ;
            echo ' ';
               echo'<a class="btn btn-danger" href="delete_cigusta.php?id=' . $repas['id'] .'"
