...
?>
    ...
    <div class="row">
        ...
        <br>
        <form class="form" role="form" action="delete_cigusta.php" method="post">
            ...
            <div class="form-action">
                <button type="submit" class="btn btn-warning"
                 data-bs-toggle="tooltip" data-bs-placement="top" title="Cette action est irréversible">Oui</button>
                <a class="btn btn-default" href="index_cigusta.php"
