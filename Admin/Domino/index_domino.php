...
?>
    <div class="row">
       <h1><strong>Liste des items </strong><a href="insert_domino.php" class="btn btn-success btn-lg"
       data-bs-toggle="tooltip" data-bs-placement="top" title="Ajouter un repas">
        ...
        <h4 ><a href="../../domino.php" style="color: #e7480f;;
text-shadow: 2px 2px black;font-family: 'Holtwood One SC';">Domino</a></h4>
        ...
        menu.nom AS category_id FROM repas LEFT JOIN menu ON repas.category_id = menu.id WHERE `restau_id`= 7 
        ...
        while($repas = $statement->fetch())
        {
           ...
           echo'<td>'.$repas['nom']. '</td>' ;
            ...
            echo'<td width="300"> '  ;
             echo'<a class="btn btn-default" href="view_domino.php?id=' . $repas['id'] .'"
 data-bs-toggle="tooltip" data-bs-placement="top" title="Voir le repas"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>' ;
             echo ' ';
              echo'<a class="btn btn-primary" href="update_domino.php?id=' . $repas['id'] .'"
 data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier le repas"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>'  ;
            echo ' ';
               echo'<a class="btn btn-danger" href="delete_domino.php?id=' . $repas['id'] .'"
