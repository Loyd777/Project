...
//Vérification du remplissement des champs.
 if (!empty($_POST))
 {
     ...
     if ($isSucces && $isUploadSucces){
         $db = Database::connect();
         $statement = $db->prepare("INSERT INTO repas (nom,description,price,category_id,image,restau_id) value(?, ?, ?, ?, ?,7) ");
...
?>
        ...
        <br>
        <form class="form" role="form" action="insert_domino.php" method="post" enctype="multipart/form-data">
